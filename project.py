...
# below is a login function that renders login page and passes the state value into it
@app.route('/login')
def showLogin():
...
# below function calls the gdisconnect function and redirects the user to home page
@app.route('/logout')
def logout():
    gdisconnect()
...
# below function contains steps for obtaining authorization code for google
...
# below function displays specific item information from one particular category
...
# below function allows user to update item description from a particular category
...
# below function extracts user info from login session and stores it in a user table
